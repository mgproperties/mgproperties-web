        ...
        <div className="text-center">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-xl md:text-2xl text-white/90 leading-relaxed mb-8 font-medium">
              Ready to start your real estate journey? Our expert team is here to guide you through every step of the
              process with personalized service and professional expertise.
            </p>

            <p className="text-lg text-white/80 leading-relaxed max-w-3xl mx-auto">
              Whether you're buying, selling, or investing, we're committed to making your real estate experience
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-16 max-w-5xl mx-auto">
            {[
              ...
              { icon: Mail, label: "Email Us", value: "info@primerealty.com" },
              { icon: MapPin, label: "Visit Us", value: "123 Real Estate Ave" },
              ...
              >
                ...
                <div className="text-sm text-white/70 font-medium mb-1">{item.label}</div>
