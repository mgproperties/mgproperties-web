...
import { Home, Search, FileText, Key, TrendingUp, Users, ArrowRight } from "lucide-react"

const services = [
  {
    icon: Search,
    title: "Property Search",
    description: "Find your perfect home with our advanced search tools and expert guidance through every step.",
  ...
  },
  {
    ...
    description:
      "Get accurate market valuations for your property with our comprehensive analysis and market insights.",
    color: "from-accent to-accent-600",
  },
  {
    icon: FileText,
    title: "Legal Assistance",
    description: "Navigate complex paperwork and legal requirements with our experienced team of professionals.",
    color: "from-secondary to-secondary-600",
  },
  {
    icon: Key,
    title: "Property Management",
    description: "Full-service property management for landlords and real estate investors seeking passive income.",
    color: "from-primary to-accent",
  },
  {
    icon: TrendingUp,
    title: "Investment Consulting",
    description: "Strategic advice for real estate investments and portfolio growth with proven market strategies.",
  ...
  },
  {
    ...
    description:
      "Comprehensive support for individuals and families relocating to new areas with seamless transitions.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            From property search to investment consulting, we provide comprehensive services tailored to your unique
            needs and goals
          </p>
        </div>
