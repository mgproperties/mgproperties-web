...
import { Send, User, Mail, Phone, MessageSquare, Home, DollarSign } from "lucide-react"
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  description: "98% client satisfaction rate with over 500 successful transactions in the past year.",
