            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-20">
                    ...
                    <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                        We've built our reputation on delivering exceptional
                        results through innovation, expertise, and unwavering
                ...
                <Card className="bg-gradient-to-br from-secondary via-secondary to-secondary/90 rounded-3xl border-0 overflow-hidden relative">
                    ...
                    {/* <CardContent className="p-12 text-center relative z-10">
                        ...
                        <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                            Let our experienced team guide you through every
                            step of buying, selling, or investing in real
                            estate.
                        </p>
