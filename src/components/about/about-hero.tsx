                ...
                <div className="text-center">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <p className="text-xl md:text-2xl text-white/90 leading-relaxed mb-8 font-medium">
                            For over 15 years, we've been helping families and
                            investors find the perfect properties through
                            personalized service, market expertise, and
                            unwavering commitment to excellence.
                        </p>

                        <p className="text-lg text-white/80 leading-relaxed max-w-3xl mx-auto">
                            From first-time homebuyers to seasoned investors,
                            we've built our reputation on trust, integrity, and
                        ...
                        {[
                            {
                                icon: TrendingUp,
                                value: "5000+",
                                label: "Properties Sold or Rented Out",
