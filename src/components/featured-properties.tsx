...
import { Bed, Bath, Square, MapPin, Heart, Share2, ArrowRight } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Discover our carefully curated selection of exceptional homes that define luxury living and smart
            investments
          </p>
        </div>
