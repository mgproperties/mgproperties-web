...
export function PropertyDetail({ property }: PropertyDetailProps) {
	...
	return (
		<section className="py-24 pt-40 bg-gradient-to-b from-slate-100 to-slate-200 relative overflow-hidden">
			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				<div className="flex flex-col md:flex-row md:items-center justify-between mb-12">
					...
					<div className="mt-6 md:mt-0 flex flex-col items-start md:items-end gap-4">
						<Badge
							className={`px-5 py-2 rounded-full text-lg font-semibold hover:bg-current`}
						>
							{property.status}
						</Badge>
